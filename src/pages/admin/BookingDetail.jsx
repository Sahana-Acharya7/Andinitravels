...
const styles = {
  ...
  label: { color: '#64748b', fontSize: '0.9rem', minWidth: '120px', maxWidth: '140px', fontWeight: '600' },
  value: { fontWeight: '500', fontSize: '0.96rem', textAlign: 'right', whiteSpace: 'pre-wrap', wordBreak: 'break-all', overflowWrap: 'anywhere', flex: 1 },
  input: {
    border: '1.5px solid #dbe2f1',
    borderRadius: '8px',
